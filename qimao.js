...
async function MxsTask1() {
    ...
    let body = `position_id=inchapter_top&type=1`;
...
async function MxsTask2() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=2`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
...
async function MxsTask3() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=3`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
...
async function MxsTask4() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=4`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
...
async function MxsTask5() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=5`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
...
async function MxsTask6() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=6`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
...
async function MxsTask7() {
    ...
    let caller = printCaller()
    let url = `https://api-ks.wtzw.com/api/v1/coin/add`;
    let body = `position_id=inchapter_top&type=7`;
    let urlObject = populatePostUrl(url,body)
    await httpPost(urlObject,caller)
    let result = httpResult;
    if(!result) return
